# PowerChain Administration

**Package:** `@powerchain/app-admin`  
**Version:** `1.0.0`  
**Development port:** `3010`

## Purpose

Organization, identity, policy, audit and system-administration workspace.
...
```bash
pnpm --filter @powerchain/app-admin dev
pnpm --filter @powerchain/app-admin typecheck
pnpm --filter @powerchain/app-admin build
```
