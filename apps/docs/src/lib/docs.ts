...
export const DOCS: readonly DocDefinition[] = [
  ...
  },
  {
    ...
    description: "Pyth, Birdeye, CoinMarketCap and fixed-point currency-rate processing.",
    group: "Platform",
  },
  {
    slug: "explorers",
    ...
    description: "Solscan and Suiscan explorer URL integration.",
    group: "Networks",
  },
  {
    slug: "rewards",
    file: "REWARDS.md",
    title: "Reward Epochs",
    description: "PWRC reward epochs, deterministic allocations and claims.",
    group: "Platform",
  },
  {
    slug: "safe-actions",
    file: "SAFE-ACTIONS.md",
    title: "Safe Actions",
    description: "Idempotency, rate limiting and write-policy enforcement.",
    group: "Operations",
  },
  {
    slug: "security",
