...
ensure(".github/copilot-instructions.md", `# PowerChain Copilot instructions\n\nFollow AGENTS.md and the canonical PowerChain v1.0.0 architecture. Preserve bigint Wh accounting, tenant isolation, idempotent economic mutations, explicit runtime modes, and PWRC/wPWRC/Energy RWA separation. Never invent live operational data.\n`);
