...
**Package:** `@powerchain/app-mapper`  
**Version:** `1.0.0`  
**Development port:** `3011`

## Purpose

Geospatial workspace for grid and physical-energy infrastructure context.
...
```bash
pnpm --filter @powerchain/app-mapper dev
pnpm --filter @powerchain/app-mapper typecheck
pnpm --filter @powerchain/app-mapper build
```
